      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-neutral-900/90 via-neutral-900/60 to-neutral-950 border border-neutral-800/90 p-6 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-md overflow-hidden">
          ...
          <div className="relative z-10 space-y-5 sm:space-y-6">
            ...
            {/* H2 Heading - Strictly Non-Bold */}
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-normal text-white font-['Outfit'] tracking-tight leading-snug">
              Do You Charge Extra to{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-amber-400 font-normal">
                Come to My Town?
              </span>
            </h2>
            ...
            {/* Content Paragraphs - Non-Bold & Light */}
