  ...
  return (
    <section id="cta" className="relative bg-neutral-950 py-12 sm:py-16 lg:py-20 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Sleek Minimal Consultation Banner Card matching Home Screen */}
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10 text-center lg:text-left">
            ...
            <div className="max-w-2xl space-y-3">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-xs font-bold text-red-400">
                ...
                <span>Two Brothers · We Bring The Detailing To You</span>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed font-normal">
                  Tell us what you drive and where you are, and we will send you a straight price. No pressure, no runaround. If your vehicle is rough, do not worry about it. Those are the fun ones.
                </p>
              </div>
            </div>
