...
export default function PricingCtaSection() {
  return (
    <section id="cta" className="relative bg-neutral-950 py-12 sm:py-16 lg:py-20 select-none overflow-hidden border-t border-neutral-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Sleek Minimal Consultation Banner Card matching About & Home Pages */}
        <div className="relative rounded-3xl bg-gradient-to-r from-neutral-900 via-neutral-900 to-neutral-950 border border-neutral-800 p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10 text-center lg:text-left">
            ...
            <div className="max-w-2xl space-y-2.5">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-xs font-medium text-red-400">
                <Sparkles className="w-3.5 h-3.5 text-red-500" />
                <span>Upfront Estimates · Honest Same-Day Answers</span>
              </div>

              <h2 className="text-xl sm:text-2xl lg:text-3xl font-normal text-white font-['Outfit'] leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full sm:w-auto">
              <a
                href="/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 shadow-md shadow-red-600/20 hover:-translate-y-0.5 transition-all duration-200 border border-red-500/40"
              >
