  ...
  return (
    <section id="service-area" className="relative bg-neutral-900/40 py-20 sm:py-24 lg:py-28 border-b border-neutral-800/80 overflow-hidden select-none">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        {/* 6 Geographic Region Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14 sm:mb-16">
          {serviceRegions.map((regionItem, index) => (
            <div
              key={index}
              className={`rounded-2xl p-6 sm:p-7 border backdrop-blur-md flex flex-col justify-between transition-all duration-300 ${
                regionItem.badge
